...
/**
 * Abstract base class to reuse code between preferences pages.
 * 
 * @author jfernandes
 */
abstract class AbstractWollokPropertyAndPreferencePage extends PropertyAndPreferencePage {
	@Inject @Named(Constants.LANGUAGE_NAME) String languageName
	@Inject IPreferenceStoreAccess preferenceStoreAccess
	OptionsConfigurationBlock configurationBlock
	...
	abstract def String pageID()
	
	abstract def OptionsConfigurationBlock createBlock(IProject project, IPreferenceStore preferenceStore, IWorkbenchPreferenceContainer container)
	...
	override createControl(Composite parent) {
		...
		configurationBlock = createBlock(project, preferenceStore, container)
