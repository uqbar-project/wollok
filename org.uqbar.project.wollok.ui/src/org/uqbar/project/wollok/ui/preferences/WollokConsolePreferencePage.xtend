...
class WollokConsolePreferencePage extends PropertyAndPreferencePage implements IWorkbenchPropertyPage {
	@Inject @Named(Constants.LANGUAGE_NAME) String languageName
	@Inject IPreferenceStoreAccess preferenceStoreAccess
	WollokConsoleConfigurationBlock builderConfigurationBlock
	...
	override createControl(Composite parent) {
		...
		builderConfigurationBlock = new WollokConsoleConfigurationBlock(project, preferenceStore, container)
