...
public class ExportGamePage extends WizardPage{
	 private Text text1;
	  private Composite container;

	  public ExportGamePage() {
	    super("Export Wollok Game");
	    setTitle("Export Wollok Game");
	    setDescription("Export Wizard: Export settings from Wollok Game");
	  }
